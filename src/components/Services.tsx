...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      features: [
        "AI restoration for 5 photos",
        "All features from single restore",
    ...
    },
    {
      ...
      features: [
        "AI + Human expert touch",
        "Repairs tears & water damage",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card key={index} className={`relative ${service.popular ? 'border-blue-500 border-2 shadow-lg' : 'border-gray-200'} hover:shadow-xl transition-all duration-300`}>
              {service.popular && (
              ...
              <CardFooter>
                <Button 
                  className={`w-full ${service.popular ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-800 hover:bg-gray-900'} text-white`}
