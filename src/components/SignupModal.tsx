      ...
      <DialogContent className="max-w-md mx-auto bg-white">
        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="space-y-3">
            <Button onClick={handleGoogleSignup} disabled={isLoading} className="w-full h-12 bg-yellow-100 border border-gray-300 text-gray-700 hover:bg-gray-50 flex items-center justify-center gap-3">
